...
<br />
<div align="center">
  <a href="https://github.com/digitalcloudninja/configuration">
    <img src="https://avatars.githubusercontent.com/u/174159620?v=4" alt="Logo" width="160" height="160">
  </a>

<h1 align="center">Configuration Service</h1>
...
<a href="https://github.com/digitalcloudninja/configuration"><strong>Explore the Documentation »</strong></a>
<p align="right">(<a href="#readme-top">back to top</a>)</p>
...
1. Clone the repo
   ```sh
   git clone https://github.com/digitialcloudninja/configuration.git
   ```
2. Build packages
   ```sh
   gradle build
